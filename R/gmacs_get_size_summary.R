#' Get Size Composition Summary
#'
#' Isolate size composition summary data from Gmacsall.out by model
...
#' @return Tibble of size composition summary from Gmacsall.out in long format with column 'model'.
#' @examples gmacs_get_size_summary(all_out = list(mod_23.0a, mod_23.1b))
#'
#' @export
#'
gmacs_get_size_summary <- function(all_out = NULL, file = NULL, model_name = NULL, version = NULL){
