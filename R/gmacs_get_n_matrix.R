#' Get N Matrices
#'
#' Isolate n matrices from Gmacsall.out by model
...
#' @return Tibble of N matrices from Gmacsall.out in long format with column 'model'.
#' @examples gmacs_get_n_matrix(all_out = list(mod_23.0a, mod_23.1b))
#'
#' @export
#'
gmacs_get_n_matrix <- function(all_out = NULL, file = NULL, model_name = NULL, version = NULL){
