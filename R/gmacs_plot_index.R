#' Plot Fit to Index Data
#'
#' Plot fits to index data from Gmacsall.out data summary
...
#' @return Plot of fit to index data by series
#' @examples gmacs_plot_index(all_out = list(model_25.0))
#'
#' @export
#'
gmacs_plot_index <- function(all_out = NULL, save_plot = T, plot_dir = NULL, y_labs = NULL, data_summary = NULL, file = NULL, model_name = NULL, version = NULL) {
  # get summary data
  if(is.null(data_summary)){data_summary <- gmacs_get_index_summary(all_out, file, model_name, version)}
