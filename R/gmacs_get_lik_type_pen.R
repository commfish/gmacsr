...
#'
#' Isolate likelihood components by data type (e.g., catch, index, size) including penalties from Gmacsall.out by model
...
#' @export
#'
gmacs_get_lik_type_pen <- function(all_out = NULL, file = NULL, model_name = NULL, version = NULL){
