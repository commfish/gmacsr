#' Get Index Summary
#'
#' Isolate index summary data from Gmacsall.out by model
...
#' @return Tibble of index summary from Gmacsall.out with column 'model'.
#' @examples gmacs_get_index_summary(all_out = list(mod_23.0a, mod_23.1b))
#'
#' @export
#'
gmacs_get_index_summary <- function(all_out = NULL, file = NULL, model_name = NULL, version = NULL){
